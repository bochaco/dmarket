...
const Header: React.FC<HeaderProps> = ({
  ...
  const WalletButton = () => {
    if (isWalletConnected) {
      return (
        <div className="flex items-center bg-brand-accent/20 text-lime-400 font-medium rounded-full text-sm pl-4">
          ...
          <button
            ...
            className="p-2 ml-1 rounded-full text-slate-400 hover:text-red-400 hover:bg-red-500/20 transition-colors"
